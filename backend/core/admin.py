...
from .models import User, Daycare, SubscriptionPlan, DaycareSubscription
from .models import ManagedDaycare, ManagedUser, ManagedSubscriptionPlan, ManagedDaycareSubscription
...
class SubscriptionPlanAdmin(admin.ModelAdmin):
    list_display = ('name', 'price', 'max_staff', 'max_teachers')
    search_fields = ('name',)
